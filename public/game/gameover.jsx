        ...
        <div style={{ display: "grid", gridTemplateColumns: failed ? "repeat(4, 1fr)" : "repeat(5, 1fr)", gap: 12, marginBottom: 24 }}>
          {!failed && (
            <>
              ...
              <Stat label="Total Return" value={`${(stats.totalReturn * 100).toFixed(1)}%`} sub={`${GBE.fmt$(stats.totalDividendsPaid || 0)} in divs`} tone={stats.totalReturn > 0.80 ? GP.good : stats.totalReturn > 0 ? GP.warn : GP.bad} />
