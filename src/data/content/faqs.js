...
export const FAQS = [
  {
    ...
    "shortAnswer": "Bank stocks are shares of ownership in publicly traded banks and bank holding companies. They differ from other stocks because banks carry far more leverage, earn most of their revenue from interest rather than product sales, face intensive regulatory oversight, and require a distinct set of financial metrics to evaluate.",
    "fullAnswer": "Bank stocks are shares of ownership in publicly traded commercial banks, savings institutions, and bank holding companies. They trade on stock exchanges like any other equity, but the businesses behind them operate in ways that set them apart from nearly every other industry.\n\nThe most fundamental difference is leverage. A typical industrial company might fund 30-50% of its assets with debt. A bank funds 88-92% of its assets with deposits and borrowings, leaving only 8-12% funded by equity. This extreme leverage means that small changes in asset values or earnings have an outsized impact on shareholder returns, both positive and negative. A 1% return on assets translates to roughly a 10% return on equity at typical bank leverage levels. It also means that even modest credit losses can rapidly erode the thin equity cushion, which is why bank regulators pay such close attention to capital adequacy.\n\nBank financial statements look different from those of non-financial companies in almost every respect. Revenue for most companies comes from selling products or services. For banks, the primary revenue source is net interest income (NII): the spread between interest earned on loans and investments and interest paid on deposits and borrowings. Fee income from services like wealth management, mortgage origination, and transaction processing provides a secondary revenue stream, and some banks have built substantial fee-based businesses that reduce their dependence on interest rate cycles. Standard metrics like EV/EBITDA, operating margin, and free cash flow, which are staples of industrial company analysis, simply do not apply to banks. Deposits are both a funding source and a product, so the usual distinction between operating costs and financing costs breaks down entirely.\n\nThe bank stock universe itself is unusually broad and varied. There are over 300 publicly traded banks in the United States alone, ranging from community banks with a few hundred million dollars in assets and a handful of branches to money center institutions with trillions on their balance sheets and global operations. Community and regional banks tend to focus on traditional lending and deposit-gathering in specific geographic markets. Larger banks often have significant capital markets, trading, and investment banking operations alongside their commercial and retail banking units. A community bank in a rural farming region and a global banking conglomerate have fundamentally different risk profiles, growth trajectories, and competitive dynamics, even though both fall under the same label.\n\nRegulation adds another layer of distinction. Banks are among the most heavily regulated businesses in the economy. Federal and state regulators set minimum capital requirements, conduct on-site examinations, approve or deny mergers and acquisitions, and can restrict dividend payments or share buybacks if capital levels fall below required thresholds. Larger banks face additional oversight layers, including annual stress tests that model how the institution would perform under severe economic scenarios. These regulatory constraints directly affect profitability, growth potential, and shareholder returns in ways that few other industries experience. A bank cannot simply decide to return excess capital to shareholders the way a technology company might; it needs regulatory blessing first.\n\nThe asset quality dimension is unique to banks as well. A manufacturer worries about inventory obsolescence; a retailer about shifting consumer preferences. A bank worries about whether borrowers will repay their loans. The provision for credit losses (PCL), a non-cash charge reflecting expected future loan losses, is one of the most significant and volatile components of a bank's income statement. During stable economic periods, provisions might represent a small fraction of total loans. During downturns, they can surge to levels that consume most or all of quarterly earnings. The loan portfolio is, in many ways, the single most important asset a bank owns, and evaluating its quality requires understanding the types of loans originated, the underwriting standards applied, and the economic health of the markets the bank serves.\n\nBecause of all these structural differences, bank stock analysis relies on its own distinct set of metrics. Return on equity (ROE) measures how effectively a bank generates profit from shareholders' capital. Return on average assets (ROAA) strips out the leverage effect and shows how productively the bank uses its total asset base. Net interest margin (NIM) tracks the spread a bank earns on its lending and investing activities. The efficiency ratio reveals how much of each revenue dollar goes to operating expenses. And the price-to-book (P/B) ratio anchors valuation to the net asset base in a way that price-to-earnings alone cannot capture for a leveraged financial institution. General-purpose stock screeners and valuation tools often lack these bank-specific metrics, which is one reason bank stock investing rewards specialized analysis.\n\nBanks also stand apart from most sectors in their tradition as dividend payers. The recurring nature of interest and fee income gives well-run banks predictable cash flows, and many institutions, particularly community and regional banks, return a meaningful portion of earnings to shareholders through regular dividends. This income component makes bank stocks a fixture in many income-oriented portfolios, though dividend payments are always subject to regulatory approval and can be curtailed if a bank's capital position weakens.",
    "relatedMetrics": [
      "roe",
      "roaa",
      "net-interest-margin",
