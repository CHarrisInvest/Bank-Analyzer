...
export const FAQS = [
  {
    ...
    "shortAnswer": "Bank stocks are shares of publicly traded banks and bank holding companies. They differ from other stocks because banks use extreme leverage, earn revenue primarily from interest rate spreads, face heavy regulatory oversight, and require a completely different set of financial metrics to analyze.",
    "fullAnswer": "Bank stocks represent ownership in publicly traded commercial banks, savings institutions, and bank holding companies. They trade on stock exchanges just like shares of a technology or retail company, but the underlying businesses are fundamentally different in ways that affect everything from how you read their financial statements to how you value them.\n\nThe most striking difference is leverage. Most non-financial companies fund somewhere between 30% and 50% of their assets with debt. Banks operate at an entirely different scale — typically funding 88-92% of their assets with deposits and borrowed money, with only 8-12% coming from shareholder equity. To put that in concrete terms: a bank with $1 billion in assets might have only $90 million in equity supporting it. That kind of leverage amplifies everything. If the bank earns just 1% on its assets ($10 million), that translates to roughly an 11% return on the $90 million in equity — a solid result. But if loans go bad and the bank loses 2% of its asset value, that $20 million loss wipes out more than a fifth of the equity base. This is why small shifts in credit quality or earnings can move bank stock prices so dramatically.\n\nBank financial statements look nothing like those of a typical company. Where most businesses generate revenue by selling products or services, a bank's primary revenue source is net interest income (NII) — the difference between what it earns on loans and investments and what it pays depositors and other creditors. A secondary stream comes from fee income: overdraft charges, mortgage origination fees, wealth management fees, service charges on accounts, and interchange revenue from debit and credit card transactions. Because deposits function as both a funding source and an operating liability, standard valuation metrics like EV/EBITDA, operating margin, and free cash flow simply don't translate. Debt isn't a financing choice for a bank the way it is for an industrial company — it's the raw material of the business.\n\nRegulatory oversight is another major differentiator. Banks operate under layers of federal and state regulation that have no real equivalent in other industries. Regulators set minimum capital ratios that dictate how much equity a bank must hold relative to its risk-weighted assets. They conduct periodic examinations, review lending practices, approve or deny mergers and acquisitions, and can restrict or halt dividend payments if they determine a bank's capital position is insufficient. For investors, this means bank profitability and growth have a ceiling imposed by regulators — a profitable bank can't simply reinvest all its earnings into growth if doing so would thin its capital cushion below required levels. Regulatory actions can also change the rules mid-game, altering competitive dynamics across the industry.\n\nAsset quality is a dimension of risk that barely exists outside of financial companies. A retailer worries about unsold inventory; a manufacturer might face warranty claims. A bank's core risk is that borrowers won't repay their loans. The provision for credit losses — an accounting charge that reflects expected future defaults — is one of the largest and most volatile line items on a bank's income statement. In good economic times, this charge might be modest. During a downturn, it can consume most or all of a bank's earnings. Evaluating a bank means forming a judgment about the quality of its loan portfolio, something that requires analyzing metrics like the non-performing loans ratio, net charge-off ratio, and reserve coverage ratio.\n\nBank stocks also come in meaningfully different sizes and flavors, more so than in most industries. Community banks, typically under $10 billion in assets, focus on relationship lending in local markets. Regional banks, ranging from $10 billion to $100 billion or more in assets, serve broader geographic areas and usually offer more diversified product lines. The largest money-center banks operate globally with complex business segments spanning investment banking, trading, wealth management, and consumer lending. These categories don't just differ in scale — they have different risk profiles, growth characteristics, regulatory burdens, and valuation norms. A community bank in a growing suburban market and a global money-center bank face almost entirely different sets of opportunities and challenges, even though both are technically \"bank stocks.\"\n\nAs investments, bank stocks tend to behave differently from the broader market in a few notable ways. They're historically strong dividend payers — steady cash flows from lending and fees allow many banks to return a meaningful portion of earnings to shareholders. Bank profitability is also closely tied to interest rates and the shape of the yield curve. When the spread between short-term and long-term rates is wide, bank margins tend to expand because they borrow short (through deposits) and lend long (through mortgages and commercial loans). When the yield curve flattens or inverts, that spread compresses, squeezing profitability even at well-managed institutions. Bank stocks also carry pronounced cyclicality: they tend to outperform during economic expansions when loan demand is strong and credit losses are low, and underperform during recessions when defaults rise.\n\nBecause of all these differences, the standard toolkit for stock analysis doesn't apply cleanly to banks. Return on equity (ROE), return on average assets (ROAA), net interest margin (NIM), the efficiency ratio, and price-to-book (P/B) ratio form the core set of metrics that bank investors rely on. Price-to-earnings (P/E) still has a role but requires more context than it does for other sectors, since bank earnings are heavily influenced by provision levels that management has some discretion over. General stock screeners often lack bank-specific metrics entirely, which is one reason the sector tends to attract specialists — and why mispriced opportunities persist, particularly among the hundreds of smaller banks that receive little or no analyst coverage.",
    "relatedMetrics": [
      "roe",
      "roaa",
      "net-interest-margin",
