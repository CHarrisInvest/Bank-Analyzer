...
export const METRICS = [
  {
    ...
    "isPercentage": true,
    "shortDescription": "Measures how much profit a bank earns for each dollar of shareholder equity, reflecting both operating performance and the degree of financial leverage employed.",
    ...
    "whatDrivesMetric": "The numerator, net income, is driven by several interconnected factors:\n\n- Net interest margin (NIM) — the spread between what a bank earns on loans and investments versus what it pays on deposits and borrowings. NIM is typically the largest component of bank revenue and has the most direct impact on net income.\n\n- Fee income generation — revenue from service charges, wealth management, mortgage origination, and other non-interest sources. Banks with diversified fee income streams tend to show more stable ROE across interest rate cycles.\n\n- Operating efficiency — measured by the efficiency ratio, this reflects how much of each revenue dollar gets consumed by overhead costs. A bank that spends 55 cents to generate a dollar of revenue will naturally produce higher net income than one spending 70 cents.\n\n- Provision for credit losses — the expense banks record to build reserves against expected loan defaults. During benign credit periods, low provisions boost net income and ROE; during downturns, elevated provisions can cut deeply into earnings.\n\nThe denominator, average shareholders' equity, moves based on retained earnings accumulation, capital raises or stock issuances, share buybacks, dividend payments, and accumulated other comprehensive income (AOCI) fluctuations. Management decisions around capital allocation and dividend policy directly shape the denominator over time.\n\nMacroeconomic conditions influence ROE from multiple directions simultaneously. Rising interest rates generally widen NIM (boosting the numerator) but can also slow loan demand and increase credit stress. Strong economic growth supports loan volumes and low default rates, while recessions compress both revenue and credit quality.",
    "faqTeasers": [
      {
