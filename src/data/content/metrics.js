...
export const METRICS = [
  ...
  },
  {
    ...
    "faqTeasers": [
      ...
      {
        "question": "What are risk-weighted assets?",
        "teaser": "Risk-weighted assets form the denominator of the CET1 ratio, adjusting a bank's total assets by the credit risk of each category to determine how much capital is actually needed.",
        "faqSlug": "what-are-risk-weighted-assets",
        "faqCluster": "capital-and-risk"
      },
      {
        "question": "What is the difference between well-capitalized and adequately capitalized?",
        "teaser": "These regulatory classifications are defined by specific CET1, Tier 1, and Total Capital ratio thresholds, and falling below them triggers automatic restrictions on a bank's activities.",
        "faqSlug": "well-capitalized-vs-adequately-capitalized",
        "faqCluster": "capital-and-risk"
      }
    ],
    "relatedValuations": [
    ...
    "relatedValuationDescriptions": {
      ...
      "peer-comparison": "CET1 ratios are a standard comparison point when evaluating banks against peers, since capital adequacy directly affects a bank's risk profile, dividend capacity, and growth flexibility."
    }
  },
  {
    ...
    "faqTeasers": [
      ...
      },
      {
        ...
        "teaser": "The calculation divides Tier 1 capital (CET1 plus qualifying AT1 instruments) by risk-weighted assets. Most investors use the ratio as reported by the bank rather than calculating it from scratch.",
        "faqSlug": "how-to-calculate-tier1-ratio",
        "faqCluster": "capital-and-risk"
      },
      {
        "question": "What happens if a bank falls below minimum capital requirements?",
        "teaser": "Banks that breach minimum Tier 1 and other capital ratios face escalating regulatory consequences under the Prompt Corrective Action framework, from dividend restrictions to potential seizure.",
        "faqSlug": "what-happens-below-minimum-capital",
        "faqCluster": "capital-and-risk"
      }
    ],
    ...
    "relatedValuationDescriptions": {
      ...
      "peer-comparison": "Tier 1 ratios are a standard comparison metric when evaluating banks against peers, since capital adequacy directly affects risk profile, dividend capacity, and regulatory standing."
    }
  },
  {
    ...
    "relatedMetricDescriptions": {
      ...
      "equity-to-assets": "Equity to Assets provides a simpler accounting view of capitalization without regulatory adjustments or risk weighting, offering a useful complement to risk-based ratios.",
      ...
      "tangible-common-equity-ratio": "TCE Ratio provides an analyst-derived capital measure that strips out intangibles and uses tangible assets rather than risk-weighted assets, offering a different lens on capital adequacy than the regulatory Total Capital Ratio.",
      "pre-provision-net-revenue": "PPNR represents the first line of defense against loan losses before capital is touched, and is not captured in the Total Capital Ratio despite being a critical element of loss-absorbing capacity."
    },
    "isEducationalOnly": true,
    ...
    "faqTeasers": [
      ...
      },
      {
        ...
        "teaser": "Total Capital combines Tier 1 capital with Tier 2 instruments including subordinated debt and qualifying loan loss reserves, then divides by risk-weighted assets.",
        "faqSlug": "how-to-calculate-total-capital-ratio",
        "faqCluster": "capital-and-risk"
      },
      {
        "question": "What are risk-weighted assets (RWA) and how do they work?",
        "teaser": "Risk-weighted assets form the denominator of all three risk-based capital ratios, adjusting a bank's total assets by the credit risk of each category to determine how much capital is required.",
        "faqSlug": "what-are-risk-weighted-assets",
        "faqCluster": "capital-and-risk"
      },
      {
        "question": "What is the difference between a well-capitalized and adequately capitalized bank?",
        "teaser": "These regulatory classifications are defined by specific CET1, Tier 1, and Total Capital ratio thresholds, and falling below them triggers restrictions on a bank's activities and capital distributions.",
        "faqSlug": "well-capitalized-vs-adequately-capitalized",
        "faqCluster": "capital-and-risk"
      }
    ],
    ...
    "relatedValuationDescriptions": {
      "peer-comparison": "Total Capital Ratios are a standard comparison point when evaluating banks against peers, since capital adequacy directly affects regulatory standing, risk capacity, and capital return flexibility.",
  ...
  },
  {
    ...
    "faqTeasers": [
      ...
      },
      {
        ...
        "teaser": "The calculation divides Tier 1 capital by average total consolidated assets. The inputs come from regulatory filings, and the averaging method for assets is an important detail that affects the result.",
        "faqSlug": "how-to-calculate-leverage-ratio",
        "faqCluster": "capital-and-risk"
      },
      {
        "question": "What is the difference between a well-capitalized and adequately capitalized bank?",
        "teaser": "Regulatory capital classifications determine what restrictions a bank faces and what activities it can pursue. The leverage ratio is one of the thresholds that determines whether a bank qualifies as well-capitalized.",
        "faqSlug": "well-capitalized-vs-adequately-capitalized",
        "faqCluster": "capital-and-risk"
      }
    ],
    ...
    "relatedValuationDescriptions": {
      "peer-comparison": "Leverage ratios are a standard comparison point when evaluating banks against peers, since capital adequacy relative to total assets provides a direct, non-risk-weighted measure of capitalization that is comparable across institutions.",
