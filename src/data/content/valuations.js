...
export const VALUATION_METHODS = [
  {
    ...
    "shortDescription": "A classic value investing formula that estimates the maximum fair price a defensive investor should pay for a stock, based on its earnings per share and book value per share.",
    "description": "The Graham Number is a valuation formula developed by Benjamin Graham, widely regarded as the father of value investing and a major influence on investors like Warren Buffett. The formula calculates the maximum price a defensive investor should pay for a stock by combining two fundamental measures: earnings per share (EPS) and book value per share (BVPS). Graham believed that a stock should not trade at more than 15 times earnings or 1.5 times book value, and the Graham Number captures both constraints in a single figure.\n\nFor bank stock investors, the Graham Number holds particular appeal because banks are naturally evaluated on both earnings multiples and book value multiples. Unlike technology or consumer companies where book value may have little connection to the business's worth, a bank's book value represents the net worth of its lending and deposit-taking operations — assets and liabilities that are largely financial in nature. This makes the formula's dual reliance on EPS and BVPS a better conceptual fit for banks than for many other industries.\n\nThe Graham Number produces a single dollar figure representing a conservative ceiling on what the stock should be worth. When a bank's share price falls below its Graham Number, the stock may warrant closer examination as a potential value opportunity. When the share price exceeds the Graham Number, the stock is trading above what Graham considered a defensive investor's limit — though that alone does not make it overvalued, since the formula intentionally sets a conservative bar.",
    "formula": "Graham Number = √(22.5 × EPS × BVPS)",
    "formulaExplanation": "The constant 22.5 comes from multiplying Graham's maximum acceptable P/E ratio of 15 by his maximum acceptable P/B ratio of 1.5 (15 × 1.5 = 22.5). EPS is earnings per share, typically using diluted trailing twelve-month figures. BVPS is book value per share, calculated as total shareholders' equity divided by shares outstanding. The square root operation converts the product back into a per-share price figure. If either EPS or BVPS is negative, the formula cannot produce a meaningful result.",
    "steps": [
      "Determine the trailing twelve-month diluted earnings per share (EPS). Use diluted EPS rather than basic EPS to account for stock options, convertible securities, and other potential dilution. For banks, verify that the EPS figure is not distorted by large one-time items such as securities gains, restructuring charges, or unusually high provision expenses.",
      "Calculate the book value per share (BVPS) from the most recent balance sheet. Divide total shareholders' equity by the number of diluted shares outstanding. For banks with significant goodwill from acquisitions, also note the tangible book value per share (TBVPS) as a cross-check.",
      "Multiply EPS by BVPS, then multiply that result by 22.5. This produces the value under the square root sign in the formula.",
      "Take the square root of the result to arrive at the Graham Number. This figure represents the maximum price Graham's framework considers appropriate for a defensive investor.",
      "Compare the Graham Number to the current stock price. If the stock trades below the Graham Number, it passes Graham's initial screen. If it trades above, it does not meet the criteria for a defensive purchase at the current price."
    ],
    "example": "Consider a regional bank with diluted EPS of $4.00 and BVPS of $40.00. The Graham Number calculation proceeds as follows: 22.5 × $4.00 × $40.00 = $3,600, and the square root of $3,600 = $60.00. If this bank's stock trades at $48 per share, the Graham Number exceeds the market price by $12, suggesting the stock passes Graham's initial value screen.\n\nNow consider what happens if that same bank had a difficult year with elevated loan loss provisions that pushed EPS down to $2.50 while BVPS remained at $40.00. The Graham Number drops to √(22.5 × $2.50 × $40.00) = √$2,250 = approximately $47.43. At a $48 share price, the stock now fails the Graham Number test — not because the bank became less valuable, but because the formula is responding to temporarily depressed earnings. This illustrates why the Graham Number works best with normalized or sustainable earnings rather than a single quarter or year that may not represent the bank's true earning power.\n\nFor comparison, a highly profitable bank with EPS of $6.00 and BVPS of $45.00 would have a Graham Number of √(22.5 × $6.00 × $45.00) = √$6,075 = approximately $77.94. The higher Graham Number reflects both the bank's stronger earnings and its greater asset base, demonstrating how the formula rewards banks that score well on both dimensions.",
    "strengths": [
      ...
      "Combines both earnings power and asset value into one calculation, which aligns well with how bank stocks are evaluated. Most bank valuation methods focus on either P/E or P/B in isolation; the Graham Number requires that a stock look reasonable on both measures simultaneously.",
      "The calculation is straightforward and requires only two inputs (EPS and BVPS), both of which are readily available in bank financial statements and earnings releases. No subjective assumptions about growth rates, discount rates, or terminal values are required.",
      "Rooted in Benjamin Graham's investment philosophy, which emphasizes paying a conservative price for demonstrable value. The framework has survived decades of market cycles, and its conservative orientation is well-suited to the banking sector where downside protection matters."
    ],
    "limitations": [
      "Does not account for growth prospects, management quality, or franchise value. A well-managed bank with strong growth potential and a highly profitable deposit franchise will produce the same Graham Number as a poorly managed bank with identical EPS and BVPS figures.",
      "May systematically undervalue high-quality banks that deserve premium valuations. Banks with consistently high returns on equity, strong fee income, and durable competitive advantages often trade above their Graham Number for good reason.",
      "Requires both positive earnings and positive book value to function. Banks experiencing losses or with negative tangible equity (rare but possible after large write-downs) cannot be evaluated with this formula.",
      "Does not distinguish between reported book value and tangible book value. Banks carrying substantial goodwill from acquisitions will show a higher BVPS and therefore a higher Graham Number than their tangible asset base justifies.",
      "The 22.5 constant reflects Graham's mid-twentieth-century assumptions about maximum reasonable multiples. In prolonged low-interest-rate environments, average bank multiples may run higher than 15x earnings or 1.5x book value, making the constant overly restrictive. In stressed credit environments, even these multiples may be generous.",
      "Uses a point-in-time EPS figure that may not represent the bank's normalized earning power, particularly during credit cycle peaks or troughs when provisions swing sharply."
    ],
    "bankSpecific": "The Graham Number is a natural fit for bank stock screening because the two inputs it requires — earnings per share and book value per share — are the same fundamental measures that drive most bank valuations. Banks are balance-sheet-intensive businesses whose assets and liabilities are predominantly financial instruments carried near fair value, making book value a more meaningful anchor for banks than for asset-light industries like technology or services.\n\nThat said, several bank-specific factors affect how investors should interpret the Graham Number:\n\n- Asset quality differences between banks are invisible to the formula. A bank with a clean loan portfolio and a bank with rising delinquencies will produce identical Graham Numbers if their EPS and BVPS happen to match. The Graham Number cannot distinguish between high-quality and deteriorating earnings.\n\n- Goodwill and intangible assets inflate BVPS for banks that have grown through acquisitions. Because the Graham Number uses total book value rather than tangible book value, acquisition-heavy banks may show a Graham Number that overstates the conservative fair value. Running the calculation a second time with tangible book value per share can reveal whether goodwill is materially affecting the result.\n\n- Regulatory capital requirements create a floor beneath bank valuations that the Graham Number does not explicitly consider. A bank trading below book value but well above its minimum capital requirements occupies a different risk position than one trading below book value with thin capital buffers.\n\n- Bank earnings are cyclical, driven by credit quality, interest rate movements, and provision expense timing. The Graham Number is only as reliable as the EPS input, which can shift meaningfully from year to year as the credit cycle evolves. Using a multi-year average EPS or pre-provision earnings per share can partially address this limitation.",
    "whenToUse": "The Graham Number works best as a quick screening filter rather than a standalone valuation. It excels at identifying bank stocks that may be trading below a conservative estimate of fair value derived from both earnings power and balance sheet strength.\n\nThe calculation is most reliable when applied to banks with stable, repeatable earnings and a book value that closely approximates tangible net asset value. Community banks with straightforward lending operations and limited goodwill tend to produce the most meaningful Graham Number results.\n\nThe method is less appropriate in several situations:\n\n- Banks with highly volatile earnings, particularly those experiencing a credit cycle spike in provision expense or benefiting from unusually large reserve releases\n\n- Banks with significant goodwill on the balance sheet, which inflates BVPS and therefore pushes the Graham Number higher than the tangible asset base supports\n\n- Banks with negative or near-zero EPS, where the formula produces artificially low or undefined results\n\n- Banks undergoing restructuring, strategic transformation, or regulatory remediation, where current financials may not represent future earning power\n\nThe Graham Number should not serve as the sole basis for any investment decision. It is most effective when used alongside P/B analysis, P/E comparisons, ROE-based valuation frameworks, and a margin of safety assessment to build a more complete picture of a bank stock's value.",
    "methodConnections": "The Graham Number synthesizes information from both the P/E and P/B valuation frameworks into a single figure. The formula — the square root of 22.5 multiplied by EPS multiplied by BVPS — implicitly assumes a maximum P/E of 15 and a maximum P/B of 1.5 (since 15 × 1.5 = 22.5). This means the Graham Number can be understood as the geometric mean of two independent price ceilings: 15 times EPS and 1.5 times BVPS.\n\nComparing the Graham Number to the current share price produces a margin of safety estimate. If the Graham Number exceeds the share price, the stock may be undervalued by Graham's criteria, and the percentage difference represents the available margin of safety. This directly connects the Graham Number to the margin of safety concept, which quantifies the discount between market price and estimated intrinsic value.\n\nBecause the Graham Number uses BVPS rather than tangible book value per share (TBVPS), banks with substantial goodwill from acquisitions may show an inflated Graham Number. The price-to-tangible-book valuation method addresses this limitation by stripping out intangible assets. Investors often run both calculations side by side: the standard Graham Number using BVPS and a modified version using TBVPS to gauge how much goodwill affects the result.\n\nThe ROE-P/B framework offers a complementary perspective. While the Graham Number sets a static ceiling based on Graham's original multiples, the ROE-P/B framework derives a justified P/B multiple from the bank's profitability. A bank that earns a high ROE may deserve a P/B multiple well above 1.5×, which means it could trade above its Graham Number and still be reasonably valued. The two methods together help distinguish between stocks that are genuinely cheap and those that trade at low multiples for justifiable reasons.",
    "commonMistakes": "The most frequent mistake is applying the Graham Number to banks with temporarily abnormal earnings. Using EPS from a year with elevated provision expense (due to a credit downturn or large individual loan charge-offs) produces an artificially low Graham Number that understates fair value. The reverse is equally misleading — applying EPS from a year with large reserve releases or one-time gains overstates what the bank is sustainably worth. Where possible, using a normalized or multi-year average EPS produces a more representative result.\n\nUsing basic EPS rather than diluted EPS is another common error that inflates the Graham Number by ignoring the dilutive effect of stock options, warrants, and convertible instruments. Diluted EPS is the more conservative and appropriate input.\n\nFailing to account for goodwill in the BVPS input overstates the Graham Number for acquisition-heavy banks. A bank with $50 in BVPS but $15 in goodwill per share has a tangible book value of only $35 per share. Running the calculation with both figures reveals how sensitive the result is to intangible assets.\n\nTreating the Graham Number as a precise fair value target rather than a rough screening threshold leads to false confidence. The formula produces a single number, but that number is only as accurate as its two inputs and the assumption that Graham's original multiples (15x earnings, 1.5x book) are appropriate for the current environment. The Graham Number is better understood as a conservative boundary — stocks below it warrant further analysis, while stocks above it simply did not pass this particular screen.\n\nFinally, some investors apply the Graham Number in isolation without considering why a bank trades below it. A low share price relative to the Graham Number may reflect legitimate concerns about asset quality, management, regulatory issues, or structural challenges that the formula cannot capture.",
    "acrossBankTypes": "The Graham Number tends to be most reliable for community banks and smaller regional banks. These institutions typically have straightforward balance sheets built on deposits and loans, stable earnings driven primarily by net interest income, and limited goodwill. Their book value closely approximates tangible net asset value, and their earnings tend to be less volatile than those of larger, more complex institutions. For these banks, the Graham Number's assumptions fit the business well.\n\nMid-size regional banks present a mixed picture. Many have grown through acquisitions, carrying meaningful goodwill that inflates BVPS. Their earnings may include a larger share of fee income from wealth management, mortgage banking, or capital markets activities, which adds variability. The Graham Number still provides a useful reference point for these banks, but investors should consider running a parallel calculation with tangible book value per share to strip out the goodwill effect.\n\nFor large money center banks with complex balance sheets, significant trading operations, and diverse revenue streams, the Graham Number is a less reliable indicator. BVPS for these banks includes substantial intangible assets, and EPS is influenced by businesses (like investment banking and trading) that are inherently more volatile than traditional lending. The formula's simplicity, which is an advantage for simpler banks, becomes a drawback when applied to institutions whose value drivers extend well beyond net interest income and tangible equity.\n\nBanks that have recently completed mutual-to-stock conversions represent a special case. These banks typically carry excess capital — their BVPS is high relative to their current earnings capacity because the conversion proceeds sit on the balance sheet as equity that has not yet been deployed into earning assets. This results in an unusually high Graham Number relative to the share price, which can make the stock appear deeply undervalued when in reality the market is pricing the time it will take for the bank to deploy that capital productively.",
    "faqTeasers": [
      {
