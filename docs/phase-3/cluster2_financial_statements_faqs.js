...
const CLUSTER_2_FAQS = [
  ...
  },
  {
    ...
    relatedMetrics: ['roe', 'roaa', 'net-interest-margin', 'eps', 'efficiency-ratio'],
    relatedValuations: ['earnings-based-valuation', 'peer-comparison'],
  ...
  },
  {
    ...
    relatedMetrics: ['non-interest-income-to-revenue-ratio', 'efficiency-ratio', 'net-interest-margin'],
  ...
  },
  {
    ...
    relatedMetrics: ['net-interest-margin', 'non-interest-income-to-revenue-ratio', 'interest-income-to-earning-assets'],
    relatedValuations: ['peer-comparison'],
  ...
  },
  {
    ...
    relatedMetrics: ['npl-ratio', 'net-charge-off-ratio', 'loan-loss-reserve-ratio', 'reserve-coverage-ratio', 'provision-for-credit-losses-to-average-loans'],
    relatedValuations: [],
  ...
  },
  {
    ...
    relatedMetrics: ['provision-for-credit-losses-to-average-loans', 'pre-provision-net-revenue', 'net-charge-off-ratio', 'loan-loss-reserve-ratio'],
    relatedValuations: [],
    ...
    cta: {
      type: 'learn-metric',
      target: '/metrics/provision-for-credit-losses-to-average-loans',
  ...
  },
  {
    ...
    relatedMetrics: ['loan-loss-reserve-ratio', 'reserve-coverage-ratio', 'npl-ratio', 'net-charge-off-ratio'],
    relatedValuations: [],
